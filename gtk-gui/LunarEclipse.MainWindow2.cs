...
namespace LunarEclipse {
    ...
    public partial class MainWindow2 {
        ...
        private Gtk.Action TextToolAction;
        
        private Gtk.Action ImageToolAction;
        ...
        protected virtual void Build() {
            ...
            // Widget LunarEclipse.MainWindow2
            ...
            this.TextToolAction = new Gtk.Action("TextToolAction", Mono.Unix.Catalog.GetString("_Text Tool"), null, null);
            this.TextToolAction.ShortLabel = Mono.Unix.Catalog.GetString("_Text Tool");
            w2.Add(this.TextToolAction, null);
            this.ImageToolAction = new Gtk.Action("ImageToolAction", Mono.Unix.Catalog.GetString("Image Tool"), null, null);
            ...
            w1.AddUiFromString("<ui><toolbar name='toolbar2'><toolitem action='SelectionToolAction'/><toolitem action='RectangleToolAction'/><toolitem action='SquareToolAction'/><toolitem action='CircleToolAction'/><toolitem action='EllipseToolAction'/><toolitem action='PathToolAction'/><toolitem action='LineToolAction'/></toolbar></ui>");
            ...
            w8.Add(this.textview1);
            this.scrolledwindow2.Add(w8);
            this.notebook1.Add(this.scrolledwindow2);
            Gtk.Notebook.NotebookChild w11 = ((Gtk.Notebook.NotebookChild)(this.notebook1[this.scrolledwindow2]));
            w11.Position = 1;
            // Notebook tab
