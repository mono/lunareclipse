...
namespace LunarEclipse
{
	public class PropertyManager
	{
		...
		static PropertyManager()
		{
			...
			info.Add(Rectangle.StrokeThicknessProperty, new PropertyInfo(ReflectionHelper.GetData(Rectangle.StrokeThicknessProperty), PropertyType.Integer));
			...
			info.Add(Path.StrokeDashOffsetProperty, new PropertyInfo(ReflectionHelper.GetData(Path.StrokeDashOffsetProperty), PropertyType.Integer, false, true));
			info.Add(Path.StrokeStartLineCapProperty, new PropertyInfo(ReflectionHelper.GetData(Path.StrokeStartLineCapProperty), PropertyType.PenLineCap, false, true));
			info.Add(Path.StrokeEndLineCapProperty, new PropertyInfo(ReflectionHelper.GetData(Path.StrokeEndLineCapProperty), PropertyType.PenLineCap, false, true));
			...
			info.Add(Path.StrokeMiterLimitProperty, new PropertyInfo(ReflectionHelper.GetData(Path.StrokeMiterLimitProperty), PropertyType.Integer, false, true));
